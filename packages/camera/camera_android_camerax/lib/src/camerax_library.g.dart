...
class PigeonOverrides {
  ...
  /// Overrides [ExtensionsManager.getInstance].
  static Future<ExtensionsManager> Function(ProcessCameraProvider)?
  extensionsManager_getInstance;
  ...
  static void pigeon_reset() {
    ...
    extensionsManager_getInstance = null;
  }
}
...
class PigeonInstanceManager {
  ...
  static PigeonInstanceManager _initInstance() {
    ...
    ExtensionsManager.pigeon_setUpMessageHandlers(
      pigeon_instanceManager: instanceManager,
    );
...
class _PigeonCodec extends StandardMessageCodec {
  ...
  void writeValue(WriteBuffer buffer, Object? value) {
    if (value is int) {
      ...
      buffer.putUint8(139);
      writeValue(buffer, value.index);
    } else if (value is CameraXExtensionMode) {
      buffer.putUint8(140);
      writeValue(buffer, value.index);
    } else {
      super.writeValue(buffer, value);
  ...
  Object? readValueOfType(int type, ReadBuffer buffer) {
    switch (type) {
      ...
      case 140:
        final value = readValue(buffer) as int?;
        return value == null ? null : CameraXExtensionMode.values[value];
      default:
        return super.readValueOfType(type, buffer);
    }
  }
...
class ExtensionsManager extends PigeonInternalProxyApiBaseClass {
  /// Constructs [ExtensionsManager] without creating the associated native object.
  ///
  /// This should only be used by subclasses created by this library or to
  /// create copies for an [PigeonInstanceManager].
  @protected
  ExtensionsManager.pigeon_detached({
    super.pigeon_binaryMessenger,
    super.pigeon_instanceManager,
  });

  late final _PigeonInternalProxyApiBaseCodec
  _pigeonVar_codecExtensionsManager = _PigeonInternalProxyApiBaseCodec(
    pigeon_instanceManager,
  );
  ...
  static void pigeon_setUpMessageHandlers({
    ...
    BinaryMessenger? pigeon_binaryMessenger,
    PigeonInstanceManager? pigeon_instanceManager,
    ExtensionsManager Function()? pigeon_newInstance,
  }) {
    final _PigeonInternalProxyApiBaseCodec pigeonChannelCodec =
        _PigeonInternalProxyApiBaseCodec(
          pigeon_instanceManager ?? PigeonInstanceManager.instance,
  ...
  static Future<ExtensionsManager> getInstance(
    ProcessCameraProvider provider, {
    BinaryMessenger? pigeon_binaryMessenger,
    PigeonInstanceManager? pigeon_instanceManager,
  }) async {
    if (PigeonOverrides.extensionsManager_getInstance != null) {
      return PigeonOverrides.extensionsManager_getInstance!(provider);
    }
    final _PigeonInternalProxyApiBaseCodec pigeonChannelCodec =
        _PigeonInternalProxyApiBaseCodec(
          pigeon_instanceManager ?? PigeonInstanceManager.instance,
    ...
    return pigeonVar_replyValue! as ExtensionsManager;
  }

  /// Returns whether the given extension mode is available for a camera.
  Future<bool> isExtensionAvailable(
    CameraSelector cameraSelector,
    CameraXExtensionMode mode,
  ) async {
    final _PigeonInternalProxyApiBaseCodec pigeonChannelCodec =
        _pigeonVar_codecExtensionsManager;
    final BinaryMessenger? pigeonVar_binaryMessenger = pigeon_binaryMessenger;
    const pigeonVar_channelName =
    ...
    final Future<Object?> pigeonVar_sendFuture = pigeonVar_channel.send(
      <Object?>[this, cameraSelector, mode],
    );
    final pigeonVar_replyList = await pigeonVar_sendFuture as List<Object?>?;
  ...
  Future<CameraSelector> getExtensionEnabledCameraSelector(
    CameraSelector cameraSelector,
    CameraXExtensionMode mode,
  ) async {
    final _PigeonInternalProxyApiBaseCodec pigeonChannelCodec =
    ...
    return pigeonVar_replyValue! as CameraSelector;
  }

  @override
  ExtensionsManager pigeon_copy() {
    return ExtensionsManager.pigeon_detached(
      pigeon_binaryMessenger: pigeon_binaryMessenger,
      pigeon_instanceManager: pigeon_instanceManager,
    );
  }
