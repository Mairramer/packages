...
class PlatformCameraEffectState {
  ...
  List<Object?> _toList() {
    return <Object?>[type, isSupported, isActive, isSystemManaged];
  }
  ...
  static PlatformCameraEffectState decode(Object result) {
    result as List<Object?>;
    return PlatformCameraEffectState(
      type: result[0]! as PlatformCameraEffectType,
      isSupported: result[1]! as bool,
      isActive: result[2]! as bool,
      isSystemManaged: result[3]! as bool,
    );
  }
  ...
  // ignore: avoid_equals_and_hash_code_on_mutable_classes
  bool operator ==(Object other) {
    if (other is! PlatformCameraEffectState ||
        other.runtimeType != runtimeType) {
      return false;
    }
    if (identical(this, other)) {
    ...
    return _deepEquals(type, other.type) &&
        ...
        _deepEquals(isActive, other.isActive) &&
        _deepEquals(isSystemManaged, other.isSystemManaged);
  }
...
class _PigeonCodec extends StandardMessageCodec {
  ...
  void writeValue(WriteBuffer buffer, Object? value) {
    if (value is int) {
      ...
      buffer.putUint8(138);
      writeValue(buffer, value.index);
    } else if (value is PlatformCameraEffectType) {
      buffer.putUint8(139);
      writeValue(buffer, value.index);
      ...
      buffer.putUint8(146);
      writeValue(buffer, value.encode());
    } else if (value is PlatformCameraEffectState) {
      buffer.putUint8(147);
      writeValue(buffer, value.encode());
    } else {
  ...
  Object? readValueOfType(int type, ReadBuffer buffer) {
    switch (type) {
      ...
      case 139:
        final value = readValue(buffer) as int?;
        return value == null ? null : PlatformCameraEffectType.values[value];
      case 140:
      ...
      case 147:
        return PlatformCameraEffectState.decode(readValue(buffer)!);
      default:
...
class CameraApi {
  ...
  Future<List<PlatformCameraEffectState>> getCameraEffects() async {
    final pigeonVar_channelName =
        'dev.flutter.pigeon.camera_avfoundation.CameraApi.getCameraEffects$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
    ...
    return (pigeonVar_replyValue! as List<Object?>)
        .cast<PlatformCameraEffectState>();
  }

  /// Shows the system UI for video effects.
  Future<void> showSystemEffectsUI() async {
    final pigeonVar_channelName =
        'dev.flutter.pigeon.camera_avfoundation.CameraApi.showSystemEffectsUI$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
  ...
  Future<void> triggerReaction(String reactionType) async {
    final pigeonVar_channelName =
        'dev.flutter.pigeon.camera_avfoundation.CameraApi.triggerReaction$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
  ...
  static void setUp(
    ...
    }
    {
      ...
      if (api == null) {
        ...
        pigeonVar_channel.setMessageHandler((Object? message) async {
          final List<Object?> args = message! as List<Object?>;
          final PlatformCameraEffectState arg_state =
              args[0]! as PlatformCameraEffectState;
          try {
            api.effectChanged(arg_state);
            return wrapResponse(empty: true);
          } on PlatformException catch (e) {
            return wrapResponse(error: e);
          } catch (e) {
