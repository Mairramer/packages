...
enum PlatformCameraEffectType: Int {
  case portraitBlur = 0
  case faceRetouch = 1
  case hdr = 2
  case night = 3
...
/// Generated class from Pigeon that represents data sent in messages.
struct PlatformCameraEffectState: Hashable {
  var type: PlatformCameraEffectType
  var isSupported: Bool
  var isActive: Bool
  var isSystemManaged: Bool

  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ pigeonVar_list: [Any?]) -> PlatformCameraEffectState? {
    let type = pigeonVar_list[0] as! PlatformCameraEffectType
    let isSupported = pigeonVar_list[1] as! Bool
    let isActive = pigeonVar_list[2] as! Bool
    let isSystemManaged = pigeonVar_list[3] as! Bool

    return PlatformCameraEffectState(
      type: type,
  ...
  static func == (lhs: PlatformCameraEffectState, rhs: PlatformCameraEffectState) -> Bool {
    if Swift.type(of: lhs) != Swift.type(of: rhs) {
      return false
    }
    return deepEqualsMessages(lhs.type, rhs.type)
      && deepEqualsMessages(lhs.isSupported, rhs.isSupported)
      && deepEqualsMessages(lhs.isActive, rhs.isActive)
      && deepEqualsMessages(lhs.isSystemManaged, rhs.isSystemManaged)
  }

  func hash(into hasher: inout Hasher) {
    hasher.combine("PlatformCameraEffectState")
    deepHashMessages(value: type, hasher: &hasher)
    deepHashMessages(value: isSupported, hasher: &hasher)
    deepHashMessages(value: isActive, hasher: &hasher)
    deepHashMessages(value: isSystemManaged, hasher: &hasher)
  }
}
...
private class MessagesPigeonCodecReader: FlutterStandardReader {
  override func readValue(ofType type: UInt8) -> Any? {
    ...
    case 139:
      let enumResultAsInt: Int? = nilOrValue(self.readValue() as! Int?)
      if let enumResultAsInt = enumResultAsInt {
        return PlatformCameraEffectType(rawValue: enumResultAsInt)
      }
      return nil
    case 140:
    ...
    case 147:
      return PlatformCameraEffectState.fromList(self.readValue() as! [Any?])
    default:
...
private class MessagesPigeonCodecWriter: FlutterStandardWriter {
  override func writeValue(_ value: Any) {
    if let value = value as? PlatformCameraLensDirection {
      ...
      super.writeByte(138)
      super.writeValue(value.rawValue)
    } else if let value = value as? PlatformCameraEffectType {
      super.writeByte(139)
      super.writeValue(value.rawValue)
      ...
      super.writeByte(146)
      super.writeValue(value.toList())
    } else if let value = value as? PlatformCameraEffectState {
      super.writeByte(147)
      super.writeValue(value.toList())
    } else {
...
protocol CameraApi {
  ...
  func getCameraEffects(completion: @escaping (Result<[PlatformCameraEffectState], Error>) -> Void)
  /// Shows the system UI for video effects.
  func showSystemEffectsUI(completion: @escaping (Result<Void, Error>) -> Void)
  /// Triggers a specific animation reaction.
  func triggerReaction(reactionType: String, completion: @escaping (Result<Void, Error>) -> Void)
}
...
class CameraApiSetup {
  ...
  static func setUp(
    ...
    /// Gets the list of supported camera effects and their states.
    let getCameraEffectsChannel = FlutterBasicMessageChannel(
      name: "dev.flutter.pigeon.camera_avfoundation.CameraApi.getCameraEffects\(channelSuffix)",
      binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      getCameraEffectsChannel.setMessageHandler { _, reply in
        api.getCameraEffects { result in
          switch result {
          case .success(let res):
            reply(wrapResult(res))
          case .failure(let error):
      ...
      getCameraEffectsChannel.setMessageHandler(nil)
    }
    /// Shows the system UI for video effects.
    let showSystemEffectsUIChannel = FlutterBasicMessageChannel(
      name: "dev.flutter.pigeon.camera_avfoundation.CameraApi.showSystemEffectsUI\(channelSuffix)",
      binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      showSystemEffectsUIChannel.setMessageHandler { _, reply in
        api.showSystemEffectsUI { result in
          switch result {
          case .success:
            reply(wrapResult(nil))
          case .failure(let error):
      ...
      showSystemEffectsUIChannel.setMessageHandler(nil)
    }
    /// Triggers a specific animation reaction.
    let triggerReactionChannel = FlutterBasicMessageChannel(
      name: "dev.flutter.pigeon.camera_avfoundation.CameraApi.triggerReaction\(channelSuffix)",
      binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      triggerReactionChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let reactionTypeArg = args[0] as! String
        api.triggerReaction(reactionType: reactionTypeArg) { result in
          switch result {
          case .success:
            reply(wrapResult(nil))
          case .failure(let error):
      ...
      triggerReactionChannel.setMessageHandler(nil)
    }
  }
}
...
protocol CameraEventApiProtocol {
  ...
  func effectChanged(
    state stateArg: PlatformCameraEffectState,
    completion: @escaping (Result<Void, PigeonError>) -> Void)
}
class CameraEventApi: CameraEventApiProtocol {
  ...
  func effectChanged(
    ...
    let channelName: String =
      "dev.flutter.pigeon.camera_avfoundation.CameraEventApi.effectChanged\(messageChannelSuffix)"
    let channel = FlutterBasicMessageChannel(
      name: channelName, binaryMessenger: binaryMessenger, codec: codec)
